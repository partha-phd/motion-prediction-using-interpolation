                 ...
                 const mxArray *prhs[])
{
  ...
  unsafe_generatePOG_mexFunction(nlhs, plhs, nrhs, prhs);
  /* Module termination. */
                                    ...
                                    int32_T nrhs, const mxArray *prhs[4])
{
  ...
  /* Call the function. */
  generatePOG_api(prhs, nlhs, outputs);
...
/* End of code generation (_coder_generatePOG_mex.c) */
